                  ...
                  overlay={
                    <Tooltip>
                      <div style={{ textAlign: "left", fontSize: "15px" }}>
                        1. You can giveaway this NFT to a address anytime.
                      </div>
                      <br />
                      <div style={{ textAlign: "left", fontSize: "15px" }}>
                        2. Once you giveaway, the ownership of this NFT will be
                        transferred to new address and you will lose all
                        ownership.
                      </div>
                    </Tooltip>
                  }
...
const StyledNftCardOwned = styled(NftCardOwned)`
  & {
    border-radius: 16px;
...
export default StyledNftCardOwned;
